...
const generatePaginationDots = () => {
  ...
  if (currentPage > halfPagesToShow + 1) {
    dots.push(
      <div
        key={1}
        className={`pagination-dot ${1 === currentPage ? "active" : ""}`}
        onClick={() => handlePageChange(1)}
      ></div>
    );
    dots.push(<div key="start-ellipsis" className="pagination-ellipsis">...</div>);
  }
  
  // Add pages around current page
  for (let i = Math.max(1, currentPage - halfPagesToShow); i <= Math.min(totalPages, currentPage + halfPagesToShow); i++) {
    dots.push(
      <div
        key={i}
  ...
  if (currentPage < totalPages - halfPagesToShow) {
    dots.push(<div key="end-ellipsis" className="pagination-ellipsis">...</div>);
    dots.push(
      <div
        key={totalPages}
        className={`pagination-dot ${totalPages === currentPage ? "active" : ""}`}
      ...
      >
        ...
        />
              ...
              <div class="side-menu-section alphabetical">
                <div class="title-row">
                  <div class="title">Sort By:</div>
                  <a class="clear-alpha" href="#">Clear All</a>
                </div>
                <div class="alphabet-container">
                  <div class="form-options">
                  {alphabets && alphabets.map((alphabet, index) => (
             ...
             <div className="form-option" key={index}>
              ...
              <div class="side-menu-section">
                <div class="link-row"><button onClick={resetSuppliersAndMarkets}>Clear All</button></div>
              </div>
            </div>
